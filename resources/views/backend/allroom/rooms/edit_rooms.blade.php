                                                ...
                                                <form class="row g-3" action={{ route('update.room', $editData->id) }}
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="file" name="image" class="form-control"
                                                            id="image" placeholder="Phone">
                                                        <img id="showImage"
                                                            src="{{ asset(!empty($editData->image) ? url($editData->image) : url('upload/no-image.jpg')) }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        @forelse ($multiimgs as $item)
                                                            <img src="{{ asset(!empty($item->multi_img) ? url('upload/rooming/multi_img/' . $item->multi_img) : url('upload/no-image.jpg')) }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <button type="submit" class="btn btn-success"
                                                                style="margin-top: 28px;">Savccce</button>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select name="facility_name[]" id="basic_facility_name"
                                                            ...
                                                            <option value="Complimentary Breakfast">Complimentary Breakfast
                                                            </option>
                                                            ...
                                                            <option value="Laundry & Dry Cleaning">Laundry & Dry Cleaning
                                                            </option>
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        ...
                                        $(document).on("click", ".addeventmore", function() {
                                            ...
                                            console.warn(whole_extra_item_add);
