...
<div class="page-content">
    ...
    <div class="col-lg-12">
       ...
       <form  class="row g-3" action="{{ route('roles.permission.store') }}" method="post" enctype="multipart/form-data">
         @csrf
        ...
        <div class="row"> 
            ...
            <div class="col-9">
                ...
                <div class="row">
                        ...
                        <input class="form-check-input" type="checkbox" name="permission[]" value="{{ $permission->id }}"" id="flexCheckDefault{{ $permission->id }}" value="{{ $permission->id }}">
