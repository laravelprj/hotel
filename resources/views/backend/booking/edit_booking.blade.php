...
<div class="page-content">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('delete.room.assign',$assign_room->id) }}" id="delete">Delete</a>
            </td>
        </tr>
        @endforeach 
    </table>
       ...
       <div class="col-12 col-lg-4">
           <div class="card radius-10 w-100">
            <div class="card-header">
               ...
               <div class="card-body">
                <form action="{{ route('update.booking.date', $editData->id) }}" method="POST">
                    @csrf
                    <div class="row">
...
<script>
    $(document).ready(function (){
       ...
       $(".assign_room").on('click', function(e){
        e.preventDefault();
            $.ajax({
