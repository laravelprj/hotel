                                ...
                                <div class="billing-details">
                                    ...
                                    <div style="display: flex">
                                        <img style="height:100px; width:120px;object-fit: cover"
                                            src="{{ !empty($room->image) ? url($room->image) : url('upload/no-image.jpg') }} "
                    ...
                    <div class="col-lg-8 col-md-8 mt-1">
                        <div class="payment-box">
                            <div class="payment-method">
                                ...
                                <p>
                                    <input type="radio" class="pay_method" id="Vnpay" name="payment_method"
                                        value="Vnpay">
            ...
            $(function() {
                ...
                $('form.require-validation').bind('submit', function(e) {
                    ...
                    if (pay_method == undefined) {
                        ...
                        return false;
                    } else if (pay_method == 'COD' || pay_method == 'Vnpay') {} else {
                        ...
                        if (!$form.data('cc-on-file')) {
                            e.preventDefault();
                            Stripe.setPublishableKey('pk_test_51PD2LVRvVc28HE9aP6DfZQJJdfO0AtxQn6pBRSoQtckK7ASZItbtYeJMa4BxDVA6tZfRrVv94WLP3YTX6kQyvo8Q00F80mVft1');
                            Stripe.createToken({
