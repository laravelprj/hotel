                        ...
                        <div class="card-body">
                              <div class="billing-details">
                                    ...
                                    <div style="display: flex">
                                          <img style="height:100px; width:120px;object-fit: cover" src="{{ (!empty($room->image)) ? url($room->image):url('upload/no-image.jpg') }} " alt="Images" alt="Images">
