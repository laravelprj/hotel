    ...
    <div class="container">
        <div class="row">
             <div class="col-lg-3">
                ...
                @include('frontend.dashboard.component.user_menu')
...
<div class="form-group">
    ...
    <img id="showImage" src="{{ asset((!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no-image.jpg')) }}" class="rounded-circle p-1 bg-primary" width="80">
</div>
</div>
