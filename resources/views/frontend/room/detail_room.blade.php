...
<div class="room-details-area pt-100 pb-70">
    <div class="container">
            ...
            <div class="col-lg-4">
                <div class="room-details-side">
                    <div class="side-bar-form">
                        <h3>Booking Sheet </h3>
                        <form action="{{ route('user.booking.store') }}" method="post" id="bk_form"> 
                            @csrf
        ...
        <input type="hidden" id="total_adult" value="{{ $detail->total_adult }}">
        <input type="hidden" id="room_price" value="{{ $detail->price }}">
        <input type="hidden" id="discount_p" value="{{ $detail->discount }}">

                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Numbers of Persons</label>
                                        <select class="form-control" name="persion" id="nmbr_person">
                                            @for ($i = 1 ; $i <= $detail->total_adult; $i++)
                                ...
                                <span class="available_room"></span>
            ...
            <div class="col-lg-8">
                <div class="room-details-article">
                    <div class="room-details-slider owl-carousel owl-theme">
                        @foreach ($imgMul as $image) 
                        <div class="room-details-item">
                            <img src="{{ asset('upload/rooming/multi_img/'.$image->multi_img) }}" alt="Images" style="width: 860px; height:570px">
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="room-details-title">
                        ...
                        <ul>
                            ...
                            <li>
                                <b> Basic : ${{ $detail->price }}/Night/Room</b>
                            </li> 
...
<div class="side-bar-list">
    <ul>
       <li>
        <a href="#"> <b>Capacity : </b> {{ $detail->room_capacity }} Person <i class='bx bxs-cloud-download'></i></a>
        </li>
        <li>
            <a href="#"> <b>Size : </b> {{ $detail->size }}ft2 <i class='bx bxs-cloud-download'></i></a>
        </li>
...
<div class="side-bar-list">
    <ul>
       <li>
        <a href="#"> <b>View : </b> {{ $detail->view }} <i class='bx bxs-cloud-download'></i></a>
        </li>
        <li>
            <a href="#"> <b>Bad Style : </b> {{ $detail->bed_style }} <i class='bx bxs-cloud-download'></i></a>
        </li>
