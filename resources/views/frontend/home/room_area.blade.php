                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="{{ route('room.detail',$item->id) }}">
                                    <img src="{{ asset($item->image ) }}" style="width: 300px;height:250px" alt="Images">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 col-md-8 p-0">
                            <div class="room-card-content">
                                 <h3>
                                     <a href="{{ route('room.detail',$item->id) }}">{{ $item['type']['name'] }}</a>
                                </h3>
                                ...
                                <a href="{{ route('room.detail',$item->id) }}" class="book-more-btn">
                                    Book Now
                                </a>
                            </div>
                        </div>
