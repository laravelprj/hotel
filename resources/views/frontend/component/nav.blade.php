...
<div class="navbar-area">
    ...
    <div class="mobile-nav">
        <a href="index.html" class="logo">
            <img src="{{ asset($setting->logo) }}" class="logo-one" alt="Logo" style="width: 120px; height=120px;">
            <img src="{{ asset($setting->logo) }}" class="logo-two" alt="Logo" style="width: 120px; height=120px;">
        </a>
    </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-light ">
                <a class="navbar-brand" href="{{ route('frontend.index') }}">
                    <img src="{{ asset($setting->logo) }}" class="logo-one" alt="Logo" style="width: 80px; height=120px;">
                    <img src="{{ asset($setting->logo) }}" class="logo-two" alt="Logo" style="width: 120px;height=120px;">
                </a>
