            ...
            <div class="col-lg-8">
                <div class="blog-article">
                    ...
                    <div class="comments-wrap">
                        ...
                        @php
                            $comments = App\Models\Comment::where('post_id',$blog->id)->limit(5)->get();
                        @endphp
                        <ul>
                            @foreach ($comments as $cmt)
                                
                            <li>
                                <img style="width: 45px; height:50px" src="{{ asset( isset($cmt->user->photo) ?'upload/user_images/'.$cmt->user->photo : 'upload/no-image.jpg')}}" alt="Image">
                                <h3>{{$cmt->user->name }}</h3>
                    ...
                    <div class="services-bar-widget">
                        ...
                        <div class="side-bar-categories">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('blog.cat.list',$item->id) }}">{{ $item->category_name }}</a>
                                </li>
                                @endforeach
