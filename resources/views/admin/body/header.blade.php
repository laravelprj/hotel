<header>
   ...
   <a class="msg-info" href="{{ route('booking.edit',$notification->data['code']) }}" style="float: right;">Check now</a>
    ...
    @endforelse
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset((!empty( $profileData->photo)) ? url('upload/admin_images/'.$profileData->photo)
                    : url('upload/no-image.jpg'))}}" alt="Admin" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <form id="logout-form" action="{{ route('admin.logout') }}" method="POST" style="">
                        ...
                        <button type="submit"> <li><i class="bx bx-log-out-circle"></i><span>Logout</span>
                        </li></button>
                </form>
